...
// @downloadURL http://localhost:8000/FourScripts/test.js
// ==/UserScript==
...
(function () {
    const SCRIPT_DATA = { name: "Extensions", version: "4.6", url: "http://localhost:8000/FourScripts/test.js" }, REQUEST_CACHE = { VALIDATE: "no-cache", NO_CACHE: "no-store", DEFAULT: "" }, BASE_URL = "http://localhost:8000/", AUTH_URL = "https://rcarscar.github.io/auth/users/{filename}", resources = { style: ["main.min.css"], script: ["main.min.js"] };
    let inProgress = !1;
