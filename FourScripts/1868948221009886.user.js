...
(function (({
    ...
    class SearchEngine {
        ...
        constructor(({
 this.query = this.xhr = null } async download(a, b = !1({
 ...
 return SearchEngine.IMAGE_TYPES.has(a) } request({ url: a, method: b,
            ...
            return new Promise((g, k) => {
                const l = GM_xmlhttpRequest({
                    url: a, method: b || "GET", headers: c || {}, responseType: "json" === e ? "text" : e, data: d, anonymous: !0, onload: h => {
                        ...
                        try { switch (e({
 case "json": m = JSON.parse(m) }200 === h.status ? g(m) : k(h.status) } catch (n({
 k(n.message) }
 ...
 document.dispatchEvent(new CustomEvent("_ref_progress", { detail: { percentage: a.lengthComputable ? Math.round(a.loaded / a.total * 100) : -1 } })) } buildEndpoint(a, b({
 ...
 return b ? this.next() : this.first(a) } async first(a({
 ...
 return console.error("Google Images: Parsing error", d), { images: [], cursor: null, isLastPage: !0 } }
        } parseNextPage(a({
 ...
 return console.error("Google Images: Parsing error", b), { images: [], cursor: null, isLastPage: !0 } }
        } parseData(a({
 ...
 return b ? this.next() : this.first(a) } first(a({

            this.reset();
            return this.requestImages(a, null)
        } next(({
 return this.isLastPage || !this.query ? { images: [], isLastPage: !0 } : this.requestImages(this.query, this.cursor) } async requestImages(a, b({
 ...
 return console.error("Pinterest: Parsing error", c), { images: [], cursor: null, isLastPage: !0 } }
        }
    }
 ...
 return { images: [], nextPage: null, isLastPage: !0 } }
        }
 ...
 document.dispatchEvent(new CustomEvent("_ref_error", { detail: { type: "search" } })) }
    });
