(function () {
    class GPUtils_ {
        ...
        static bindMethods(a, b) { a.forEach(c => { b[c.name] = c.bind(b) }) } static computeHash(a, b = 0) {
    ...
    class GPTimelapsePlayer_ extends EventTarget {
        ...
        constructor({ image: { data: a, background: b, auth: c, meta: { author: e, title: d, date: f } }, container: g, mainContainer: h }, k = GPTimelapsePlayer_.DEFAULT_DISPLAY_MODE, l = !1) {
            ...
            b, c = this.density, e = this.eraserAlpha, d = !1) { GPUtils_.drawFunction(a, b, c, e, d) } handleDelimiters(a, b) {
    ...
    } function handleResize(a) { mainContainer.style.transform = `scale(${getScale()})` } function getScale() {
        let a = (playerWrapper.clientWidth - 180) / 1150;
        766 * a > playerWrapper.clientHeight && (a = playerWrapper.clientHeight / 766);
        return Math.min(1, a)
    } function isGPFile(a) { return a.name.toLowerCase().endsWith(`.${GP_FILE_FORMAT}`) }
    ...
    } function showLoadingSpinner() { document.documentElement.classList.add("loading") } function hideLoadingSpinner() { document.documentElement.classList.remove("loading") } function removeNoModMsg() {
    ...
    function setTitle(a, b, c) {
        ...
        playerTitle.title = ""
    } function forceResize() { player?.resizeHandler() } function saveSettings() { localStorage.setItem(STORAGE, JSON.stringify(settings)) };
