    ...
    class GPPainter_ extends EventTarget {
        ...
        constructor(a, b) {
            ...
            GPUtils_.bindMethods(
                [this.globalCoordsHandler, this.keyDownHandler, this.keyUpHandler, this.inject, this.searchDrawContainer, this.getFillData, this.saveImage, this.clearPointer, this.middleButtonDown, this.rightButtonDown, this.strokeDown, this.strokeUp, this.strokeMove, this.strokeProcess,
