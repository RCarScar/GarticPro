(function () {
        ...
        constructor(a, b) {
            ...
            document.addEventListener("_auth_id", async ({ detail: { authId: c, authTypeId: d, isAuthorized: e } }) => {
                function f(q) {
                    ...
                    this.setEditionState(GPModulesManager_.STATE.ANALYTICS), this.root.abt?.showAnalyticsNotice(), f.call(this, GPModulesManager_.DEFAULT_PERMISSIONS);
            });
 ...
 left: ${e + g + 12}px`;
    ...
    class GPPainter_ extends EventTarget {
        ...
        static POINTER_OUTLINE_COLOR = "#37303fff";
        ...
        static MAX_SYMMETRY_RADIAL_GUIDES = 2048;
        static MIN_SYMMETRY_MANDALA_GUIDES = 2;
        static MAX_SYMMETRY_MANDALA_GUIDES = 64;
        ...
        static DEFAULT_BINDINGS = {
            ...
            save: [["ControlLeft", "KeyS"]],
            brushTool: [["KeyB"]],
            eraserTool: [["KeyE"]], rectangleTool: [], rectangleFilledTool: [], circleTool: [],
        ...
        static SETTINGS_UI = {
            ...
            defaultThickness: { type: "slider", args: { min: 2, max: 600, step: 1 }, description: "\u0422\u043e\u043b\u0449\u0438\u043d\u0430 \u043a\u0438\u0441\u0442\u0438 \u043f\u043e \u0443\u043c\u043e\u043b\u0447\u0430\u043d\u0438\u044e (\u0443\u0441\u0442\u0430\u043d\u0430\u0432\u043b\u0438\u0432\u0430\u0435\u0442\u0441\u044f \u0432 \u043d\u0430\u0447\u0430\u043b\u0435 \u043a\u0430\u0436\u0434\u043e\u0433\u043e \u0440\u0430\u0443\u043d\u0434\u0430)" }, defaultOpacity: { type: "slider", args: { min: .01, max: 1, step: .01 }, description: "\u041d\u0430\u0441\u044b\u0449\u0435\u043d\u043d\u043e\u0441\u0442\u044c \u043a\u0438\u0441\u0442\u0438 \u043f\u043e \u0443\u043c\u043e\u043b\u0447\u0430\u043d\u0438\u044e (\u0443\u0441\u0442\u0430\u043d\u0430\u0432\u043b\u0438\u0432\u0430\u0435\u0442\u0441\u044f \u0432 \u043d\u0430\u0447\u0430\u043b\u0435 \u043a\u0430\u0436\u0434\u043e\u0433\u043e \u0440\u0430\u0443\u043d\u0434\u0430)" },
            _2: { text: "Thickness" }, minThickness: { type: "slider", args: { min: 0.001, max: 600, step: 1 }, description: "\u041c\u0438\u043d\u0438\u043c\u0430\u043b\u044c\u043d\u0430\u044f \u0442\u043e\u043b\u0449\u0438\u043d\u0430 \u043a\u0438\u0441\u0442\u0438, \u0440\u0435\u0433\u0443\u043b\u0438\u0440\u0443\u0435\u043c\u0430\u044f \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u0435\u043c" }, maxThickness: { type: "slider", args: { min: 1, max: 600, step: 1 }, description: "\u041c\u0430\u043a\u0441\u0438\u043c\u0430\u043b\u044c\u043d\u0430\u044f \u0442\u043e\u043b\u0449\u0438\u043d\u0430 \u043a\u0438\u0441\u0442\u0438, \u0440\u0435\u0433\u0443\u043b\u0438\u0440\u0443\u0435\u043c\u0430\u044f \u0443\u043a\u0430\u0437\u0430\u0442\u0435\u043b\u0435\u043c" },
        ...
        constructor(a, b) {
            ...
            this.lastCoords = [0, 0]
            this.lastRectBox = null
            if (a.target != null)
                this.lastRectBox = a.target.getBoundingClientRect()
        ...
        dropperKeyUp(coordinates) {
            // if the dropper doesn't exist gg
            if (!this.isDropper)
                return

            coordinates.preventDefault()

            if (this.lastPointerEvent) {
                this.dropperUp(this.lastPointerEvent)
            }

            this.isDropper = false
            this.drawingArea.classList.remove("dropper_")

            if (!this.isDropperDown) {
                this.stroke.removeEventListener("pointermove", this.dropperMove)
            }
        }

        // ON Pointer Move,
        dropperDown(colorObject) {
            if (!this.isDropper)
                return
            this.dropperActivated = true;
            this.isDropperDown = true
            this.dropperMove(colorObject)
            this.drawingArea.classList.add("dropper-s_")
            this.stroke.setPointerCapture(colorObject.pointerId)
            this.stroke.addEventListener("pointermove", this.dropperMove)
            this.stroke.addEventListener("pointermove", () => {
                let [b,
                    c] = this.getCoords(colorObject);
                ...
                this.mColorObj = colorObject
                this.lastCoords = [b, c]
                colorObject = this.getPixelColor(b, c);
                this.colorPicker.setColor(colorObject);
                this.dispatchEvent(new CustomEvent("color", { detail: { color: colorObject } }));
                this.stroke.removeEventListener("pointermove", this.dropperMove)
            }, { once: !0 })
        }
        ...
        getPixelColor(a, b) {
            ...
            canvas.fillStyle = GPPainter_.BACKGROUND_COLOR;
            canvas.fillRect(0, 0, 1, 1);


            this.backgroundData?.length && canvas.drawImage(this.background, a, b, 1, 1, 0, 0, 1, 1);
            this.lastDrawData?.length && canvas.drawImage(this.lastDraw, a, b, 1, 1, 0, 0, 1, 1);
            canvas.drawImage(this.canvas, a, b, 1, 1, 0, 0, 1, 1);
            const [d, e, f, g] = canvas.getImageData(0, 0, 1, 1).data;

            if (g)
                return `${GPColorUtils_.rgbToHex(d, e, f)}`

            return GPPainter_.BACKGROUND_COLOR;
        }

        getPixelColorB(GPColorInfo) {
            // var [d, e] = GPColorInfo.touches ? [GPColorInfo.touches[0].clientX, GPColorInfo.touches[0].clientY] : [GPColorInfo.clientX, GPColorInfo.clientY]
            // var [f, g] = [d - this.lastRectBox.left, e - this.lastRectBox.top];
            // let xCoord = Math.round(GPColorInfo.target.width / this.lastRectBox.width * f)
            // let yCoord = Math.round(GPColorInfo.target.height / this.lastRectBox.height * g)

            // xCoord = this.isMirrored ? this.width - xCoord : xCoord;
            // yCoord = this.isVerticalMirror ? this.height - yCoord : yCoord;

            let xCoord = this.lastCoords[0]
            let yCoord = this.lastCoords[1]
            ...
            this.backgroundData?.length && canvas.drawImage(this.background, xCoord, yCoord, 1, 1, 0, 0, 1, 1);
            this.lastDrawData?.length && canvas.drawImage(this.lastDraw, xCoord, yCoord, 1, 1, 0, 0, 1, 1);
            canvas.drawImage(this.canvas, xCoord, yCoord, 1, 1, 0, 0, 1, 1);
            const [h, i, j, k] = canvas.getImageData(0, 0, 1, 1).data;

            if (k)
                return `${GPColorUtils_.rgbToHex(h, i, j)}`

            return GPPainter_.BACKGROUND_COLOR;
        }

        thicknessKeyDown(a) {
            this.isThicknessSetting = true;
        ...
        thicknessDown(a) {
            ...
            return f => {
                ...
                console.log("g: " + g + " c: " + c + " k: " + k + " d: " + d + " e: " + e)
                f =
                    Math.max(
                        Math.min(
                            this.thickness + (this.s.thicknessAxis === GPPainter_.AXIS.HORIZONTAL ? g - c : k - d) * 0.7,
                            this.s.maxThickness),
                        0.125);
                // if (f == this.s.minThickness)
                //     f = 0.125;
                c = g;
                d = k;
        ...
        } windowsInkCheck(a) { 0 === a.button && "pen" === a.pointerType && this.abt.setWindowsInkWarningState(!0) } getRandomInt(a) { return Math.floor(Math.random() * (a + 1)) } setColorPanelControlsSet(a) {
    ...
    class GPDrawInterface_ extends EventTarget {
        ...
        constructor(a,
            ...
            this.readyIcon = document.querySelector(".small");
            console.log(this.nativeOpacity)
            this.nativeOpacity.style.display = "none";
            ...
            const m =
                this.screen.querySelector(".draw").style;
