 ...
 left: ${e + g + 12}px`;
    ...
    class GPPainter_ extends EventTarget {
        ...
        static DEFAULT_SETTINGS = {
            defaultColor: "#000000", defaultThickness: 2, defaultOpacity: 1, minThickness: 2, maxThickness: 300, thicknessAxis: this.AXIS.HORIZONTAL, upThicknessDirection: this.DIRECTION.DOWN_RIGHT, doubleEraserThickness: !0, minOpacity: .02, opacitySensitivity: 1, opacityAxis: this.AXIS.HORIZONTAL,
        ...
        thicknessDown(a) {
            ...
            return f => {
                ...
                if(f <= this.s.minThickness)
                    f = 0.125;
                console.log(f);
                console.log(this.s.minThickness)
                c = g;
                d = k;
