(function () {
    ...
    (() => {
        function a(d, e, f) {
            ...
            c.app = b;
            c.mm.setModules([{ 
                id: 0, name: "GPProxy_", required: true, hidden: true }, { 
                id: 6, name: "GPAbout_", required: true, hidden: true }, { 
                id: 2, name: "GPPlayersManager_" }, { 
                id: 8, name: "GPReference_" }, { 
                id: 4, name: "GPPainter_" }], this, c)
        } const b = {
    ...
    class GPModulesManager_ extends EventTarget {
        ...
        constructor(a, b) {
            ...
            switch (a) {
                ...
                //     break;
                case GPModulesManager_.STATE.KEY: 
                his.edition.title = this.l.KEY_BTN_TTL
            }
        } formatTimeLeft(a) {
